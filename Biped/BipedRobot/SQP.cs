...
namespace BipedRobot
{
    ...
    public class SLSQPFifthOrderq1
    {
        private BRgait _gait;

        private double[] _currentParameterValues;
        private static double _step = 1e-6;
        private double _q1start;
        private double _q1end;

        public delegate double func(Expression exp);

        public SLSQPFifthOrderq1(BRgait gait, int numOfParams, double q1start)
        {
            _gait = gait;
            BRVHC vhc = gait.vhc;
            _currentParameterValues = new double[3 * numOfParams];
        ...
        public void runNumericalSLSQP()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
                solver.SetUpperBounds(new[] { 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0 });
        ...
        public void runNumericalSLSQPAlpha()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
                ...
                solver.SetMinObjective(objfunAlpha);
                //solver.AddLessOrEqualZeroConstraint(alphaMaxConstraint, 0.001);
                //solver.AddLessOrEqualZeroConstraint(dthetaConstraint, 0.001);
                //solver.AddEqualZeroConstraint(impactConstraint1, 0.00001);
                //solver.AddEqualZeroConstraint(impactConstraint2, 0.00001);
        ...
        public void runNumericalSLSQPDtheta()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
                ...
                solver.SetMinObjective(objfunDtheta);
                solver.AddLessOrEqualZeroConstraint(alphaMaxConstraint, 0.001);
                //solver.AddLessOrEqualZeroConstraint(dthetaConstraint, 0.001);
                //solver.AddEqualZeroConstraint(impactConstraint1, 0.00001);
                //solver.AddEqualZeroConstraint(impactConstraint2, 0.00001);
        ...
        public void runNumericalSLSQPDtheta2()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
        ...
        public void runNumericalSLSQPAlphaAndDtheta()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
        ...
        public void runNumericalSLSQPImpact()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
        ...
        public void runNumericalSLSQPTorque()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
        ...
        public void runNumericalSLSQPTorqueConstraint()
        {
            using (var solver = new NLoptSolver(NLoptAlgorithm.LD_SLSQP, 12, 0.0001, 100))
            {
                solver.SetLowerBounds(new[] { -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0, -100.0 });
        ...
        public double objfun(double[] p, double[] grad)
        {
            ...
            for (int i = 0; i < len; i++)
            {
                _gait.vhc.phi2Parameters["P" + (i+6).ToString()] = p[i];

            }
            for (int i = len; i < 2 * len; i++)
            {
                _gait.vhc.phi3Parameters["P" + (i + 6).ToString()] = p[i];
            ...
            if (grad != null)
            {
                ...
                for (int i = 0; i < len; i++)
                {
                    _gait.vhc.phi2Parameters["P" + (i + 6).ToString()] = p[i] + _step;
                    gradValues = evalTorques();
                    grad[i] = (Math.Pow(gradValues[0], 2) + Math.Pow(gradValues[1], 2) - (Math.Pow(values[0], 2) + Math.Pow(values[1], 2))) / _step;
                    _gait.vhc.phi2Parameters["P" + (i + 6).ToString()] = p[i];
                ...
                for (int i = len; i < 2 * len; i++)
                {
                    _gait.vhc.phi3Parameters["P" + (i + 6).ToString()] = p[i] + _step;
                    gradValues = evalTorques();
                    grad[i] = (Math.Pow(gradValues[0], 2) + Math.Pow(gradValues[1], 2) - (Math.Pow(values[0], 2) + Math.Pow(values[1], 2))) / _step;
                    _gait.vhc.phi3Parameters["P" + (i + 6).ToString()] = p[i];
        ...
        public double objfunAlpha(double[] p, double[] grad)
        {
            ...
            if (grad != null)
            {
                ...
                {
                    _gait.vhc.phi2Parameters["P" + (i + 6).ToString()] = p[i] + _step;
                    alphaVal = evaluateAlphaConstraint();
        ...
        public double objfunDtheta(double[] p, double[] grad)
        {
            ...
            if (grad != null)
            {
                ...
                {
                    _gait.vhc.phi2Parameters["P" + (i + 6).ToString()] = p[i] + _step;
                    dthetaMinVal = evaluateDthetaConstraint();
        ...
        public double objfunImpact(double[] p, double[] grad)
        {
            ...
            double impactValue1 = _gait.impactFirstLine(0,1) - _gait.impactSecondLine(0,1);
            double impactValue2 = _gait.impactFirstLine(0,1) - _gait.impactThirdLine(0,1);
            if (grad != null)
            {
                double gradValue1;
                double gradValue2;
                ...
                {
                    _gait.vhc.phi2Parameters["P" + (i + 6).ToString()] = p[i] + _step;
                    gradValue1 = _gait.impactFirstLine(0,1) - _gait.impactSecondLine(0,1);
                    gradValue2 = _gait.impactFirstLine(0,1) - _gait.impactThirdLine(0,1);
        ...
        public double geometryConstraint1(double[] p, double[] grad)
        {
            ...
            return _q1start - (p[6] + p[7] + p[8] + p[9] + p[10] + p[11]);
        }
        public double geometryConstraint2(double[] p, double[] grad)
        {
            if (grad != null)
            ...
            return p[0] - (p[0] + p[1] + p[2] + p[3] + p[4] + p[5]);
        }
        public double geometryConstraint3(double[] p, double[] grad)
        {
            if (grad != null)
